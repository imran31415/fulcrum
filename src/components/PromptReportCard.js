...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    width: '100%',
    maxWidth: isMobile ? screenWidth - 8 : 1200,
    alignSelf: 'center',
  },
  errorContainer: {
  ...
  dimensionCard: {
    ...
    borderWidth: 1,
    borderColor: '#e5e7eb',
    width: isSmallMobile ? '100%' : isMobile ? '48%' : '30%',
    maxWidth: isSmallMobile ? '100%' : isMobile ? '48%' : '30%',
  ...
  taskStatCard: {
    ...
    borderColor: '#e5e7eb',
    alignItems: 'center',
    width: isMobile ? Math.floor((screenWidth - 80) / 3) : 'auto',
    maxWidth: isMobile ? Math.floor((screenWidth - 80) / 3) : 'none',
    minWidth: isMobile ? Math.floor((screenWidth - 80) / 3) : 0,
  },
  taskStatNumber: {
  ...
  performanceCard: {
    ...
    borderColor: '#e5e7eb',
    alignItems: 'center',
    width: isMobile ? Math.floor((screenWidth - 50) / 2) : 'auto',
    maxWidth: isMobile ? Math.floor((screenWidth - 50) / 2) : 'none',
  },
  performanceLabel: {
    fontSize: 11,
    color: '#64748b',
  ...
  taskTypeCard: {
    ...
    borderColor: '#e5e7eb',
    alignItems: 'center',
    width: isMobile ? Math.floor((screenWidth - 100) / 4) : 'auto',
    maxWidth: isMobile ? Math.floor((screenWidth - 100) / 4) : 'none',
    minWidth: isMobile ? Math.floor((screenWidth - 100) / 4) : 80,
  },
  taskTypeIcon: {
    width: 32,
    height: 32,
