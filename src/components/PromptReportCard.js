          ...
          <View style={styles.mobileContainer}>
            ...
            >
              ...
              <View style={styles.reportFooter}>
                ...
                <Text style={styles.footerSubtext}>Visit zerotoken.io for advanced prompt engineering tools</Text>
              </View>
            </View>
          </View>
        </View>
              ...
              <View style={styles.performanceGrid}>
                <View style={styles.performanceCard}>
                  ...
                  <Text style={styles.performanceValue}>
                    {performance_metrics.processing_time || performance_metrics.duration || 'N/A'}
                  </Text>
...
const styles = StyleSheet.create({
  ...
  dimensionCard: {
    ...
    borderWidth: 1,
    borderColor: '#e5e7eb',
    flexBasis: isSmallMobile ? '100%' : isMobile ? '46%' : '30%',
    flexGrow: 1,
    flexShrink: 0,
    minWidth: isSmallMobile ? undefined : 140,
  },
  dimensionName: {
    fontSize: 12,
    fontWeight: '600',
  ...
  taskTypeCard: {
    ...
    borderColor: '#e5e7eb',
    alignItems: 'center',
    width: isMobile ? '23%' : 'auto',
    maxWidth: isMobile ? '23%' : 'none',
    minWidth: isMobile ? '23%' : 80,
  },
  taskTypeIcon: {
    width: 32,
    height: 32,
